...
models = {
   ' diabetes': pickle.load(open('D:\py3.11\medical diagonises ai\sourcefile\Model.sav', 'rb')),
    'heart_disease': pickle.load(open('D:\py3.11\medical diagonises ai\sourcefile\Model.sav', 'rb')),
    'parkinsons': pickle.load(open('D:\py3.11\medical diagonises ai\sourcefile\Model.sav', 'rb')),
    'lung_cancer': pickle.load(open('D:\py3.11\medical diagonises ai\sourcefile\Model.sav', 'rb')),
    'thyroid': pickle.load(open('D:\py3.11\medical diagonises ai\sourcefile\Model.sav', 'rb'))
}
